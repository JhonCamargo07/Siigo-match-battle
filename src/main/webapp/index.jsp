                    ...
                    <div class="container cuadro w-50  bg  overflow-hidden shadow-lg p-3  rounded">
                        <div class="row">
                            ...
                            <div class="text-center d-flex justify-content-around align-items-center pt-3">
                                ...
                                <% ServletContext aplicacion=request.getServletContext(); if
                                    (aplicacion.getAttribute("partidas") !=null) { List<JugadorVO> jugadores = (List
                                    <JugadorVO>) aplicacion.getAttribute("jugadores");
